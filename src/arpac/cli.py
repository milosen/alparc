from arpac.eval import to_lexicon, to_stream
from arpac.io import read_phoneme_corpus, read_syllables_corpus
import click
import logging
import os
import datetime
...
from arpac import load_phonemes, make_syllables, make_words, make_lexicons, make_streams
from arpac.types.base_types import Register

ARPAC_WORKSPACE = "arpac_workspace"
...
def setup_workspace(workspace: str, name="arpac_out"):
