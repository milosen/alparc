...
# Quick start
If you want to immediately jump in with the example notebook, please install the python environment and package manager [uv](https://github.com/astral-sh/uv) and run:
```bash
